...
Make sure to install the font for all users (not just a user-specific installation, or R may not detect the font).
To install for all users, right click the font, select "Show more options", then "Install for all users".
